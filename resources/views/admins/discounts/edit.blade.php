...
<div class="card-body">
    <form method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 ">
                <input id="inputHorizontalSuccess" value="{{$discount->information}}" name="information" type="text" placeholder="Thông tin thêm" class="form-control form-control-success">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <select id="inputHorizontalSuccess" class=" form-control form-control-success" name="discound_method">
                <option value="0" {{$discount->discount_method == 0 ? "selected" : ""}}>Đồng giá</option>
                <option value="1" {{$discount->discount_method == 1 ? "selected" : ""}}>Giảm giá(%)</option>
            </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 ">
                <input id="inputHorizontalSuccess" value="{{$discount->discount_value}} name="discount_value" type="number" placeholder="Giá trị của ưu đãi" class="form-control form-control-success">
            </div>
        </div>
