        ...
        <div id="sidebar" class="sidebar py-3">
            ...
            <ul class="sidebar-menu list-unstyled">
                ...
                <li class="sidebar-list-item">
                    <ul class="sidebar-menu list-unstyled">
                        <li class="sidebar-list-item"><a href="/admin/cinemas" class="sidebar-link text-dark"><i class="o-survey-1 me-3 text-gray"></i><span>Quản Lý Rạp</span></a></li>
                    </ul>
                </li>
                ...
                <li class="sidebar-list-item">
                    <ul class="sidebar-menu list-unstyled">
                        ...
                        <li class="sidebar-list-item"><a (click)="goToMember()" href="javascript:;" class="sidebar-link text-dark"><i class="fas fa-user-friends me-3 text-gray"></i><span>Quản
                                    Lý
                                    Người dùng</span></a></li>
                        <li class="sidebar-list-item"><a (click)="goToStaff()" href="javascript:;" class="sidebar-link text-dark"><i class="fas fa-user-friends me-3 text-gray"></i><span>Quản
                                    Lý
                                    Nhân viên</span></a></li>
